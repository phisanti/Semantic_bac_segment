...
class ImageAugmenter:
    ...
    def gaussian_noise(
        self, img: np.ndarray, mask: np.ndarray, mean=None, std=None, normalised=True
    ) -> Tuple[np.ndarray, np.ndarray]:
        """
    ...
    def change_brightness(
        self, img: np.ndarray, mask: np.ndarray, value=None
    ) -> Tuple[np.ndarray, np.ndarray]:
        """
        Args:
            image : numpy array of image
    ...
    def elastic_transform(
        self, img: np.ndarray, mask: np.ndarray, alpha=34, sigma=5, random_state=None
    ) -> Tuple[np.ndarray, np.ndarray]:
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        if (
            augmenter.last_transform == "change_brightness"
            or augmenter.last_transform == "gaussian_noise"
        ):
...
def elastic_transform_ndim(
    img: np.ndarray, ndim: int, alpha=34, sigma=5, random_state=None
) -> Tuple[np.ndarray, np.ndarray]:
    """Apply elastic deformation to images as augmentation.
...
def elastic_transform(
    self, img: np.ndarray, alpha=34, sigma=5, random_state=None
) -> Tuple[np.ndarray, np.ndarray]:
    """Apply elastic deformation to images as augmentation.
